...
This is an extremely competitive list of open source Android apps written in Java. It  picks the best Android apps written in Java that are open source. To give you an idea about the quality of this list, <b>the average number of Github stars is 3,874.</b>
...
[Mybridge](https://www.mybridge.co) initially picked the apps. You're welcome to contribute. Let's make sure the quality of application is great.
